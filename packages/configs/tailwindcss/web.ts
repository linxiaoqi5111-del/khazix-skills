...
const twConfig = {
  ...
  plugins: [
    iconsPlugin({
      collections: {
        ...getIconCollections(["lucide", "simple-icons", "logos"]),
        focal: getCollections(path.resolve(workspaceRoot!, "./icons/focal")),
      },
    }),
    ...
    try {
      ...
      parseColors(svg, {
        ...
        callback: (attr, colorStr, color) => {
          ...
          // Legacy imported icons used this default color before the focal set was regenerated.
