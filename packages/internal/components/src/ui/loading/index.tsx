    ...
    return (
      <div className={className}>
        <div style={rootStyle} className="relative inline-block">
          ...
          >
            <i
              className="i-focal-loading-3 animate-spin"
    ...
    return (
      <div className={className}>
        <div style={rootStyle} className="relative inline-block">
          ...
          >
            <i
              className="i-focal-loading-3-line animate-spin"
...
export const RotatingRefreshIcon: React.FC<{
  ...
  return <m.i className={cn("i-focal-refresh-2", className)} animate={controls} />
}
