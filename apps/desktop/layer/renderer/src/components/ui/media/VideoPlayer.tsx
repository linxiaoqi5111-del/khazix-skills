      ...
      <div className="center pointer-events-none absolute inset-0">
        ...
        >
          <i
            className={cn(
              "size-8 text-white",
              clickToStatus === "play" ? "i-focal-play-fill" : "i-focal-pause-fill",
            )}
          />
        </m.div>
      </div>
  ...
  return (
    ...
    >
      <IconScaleTransition
        ...
        icon1="i-focal-volume"
        icon2="i-focal-volume-mute"
      ...
      >
        <span className="center">
          <IconScaleTransition
            ...
            icon1="i-focal-play-fill"
            icon2="i-focal-pause-fill"
          />
        </span>
      </ActionIcon>
...
const FullScreenControl = () => {
  ...
  return (
    ...
    >
      {isFullScreen ? (
        <i className="i-focal-fullscreen-exit" />
      ) : (
        <i className="i-focal-fullscreen" />
      )}
    </ActionIcon>
  )
}
...
const VolumeControl = () => {
  ...
  return (
    ...
    >
      {muted ? (
        <i className="i-focal-volume-mute" title={t("player.unmute")} />
      ) : (
        <i className="i-focal-volume" title={t("player.mute")} />
      )}
    </ActionIcon>
  )
}
